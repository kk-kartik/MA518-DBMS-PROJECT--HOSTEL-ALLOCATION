...
<div class="collapse navbar-collapse" id="navbarNav">
 ...
 <!-- hostetl leave form -->
<div class="modal fade" id="applyhleaveModal" tabindex="-1" role="dialog" aria-labelledby="applyhleaveModalH" style="display: none; padding-right: 17px;">
									<div class="modal-dialog" style="min-width: 60%;" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title text-center" id="applyhleaveModalH">Hostel Leave Details</h5>
												<a href="javascript:void(0)" class="close closebtn" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></a>
											</div>
											...
											<div class="modal-footer">
												...
												<button class="btn btn-primary" type="submit" id="hostelLeaveReqBtn" disabled="">Submit</button>
											</div>
										</div>
									</div>
								</div>
